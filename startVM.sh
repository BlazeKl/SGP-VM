...
qemu-system-x86_64 \
    ...
    -enable-kvm -M q35 -m 8192 -watchdog ib700 -cpu host,hv_relaxed,hv_time,kvm=off,hv_vendor_id=null,-hypervisor -smp 10,sockets=1,cores=5,threads=2 \
    ...
    -drive file=/dev/sda1,format=raw,cache=writeback,if=virtio \
